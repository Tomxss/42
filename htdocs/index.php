<?php
	...
	$arr = array('index','shop','product','cart','add_to_cart','update_cart','order', 'error', 'Pink', 'firm', 'fresh', 'soft', 'landing', 'about', 'empty_cart');
