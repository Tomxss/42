...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/20 12:34:12 by tcoetzee          #+#    #+#             */
/*   Updated: 2019/09/20 12:45:25 by tcoetzee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				error_found(int *ac, char **av, int **formatted_input, \
		int **flags)
{
	int			index;
	char		**string;
